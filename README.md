...
* **Connecting Business, User Needs, and Technology**: Equipping students with the ability to bridge user needs, business goals, and technical possibilities to make informed, impactful product decisions. 
* **Practical, Real-World Application**: Providing a practitioner-led learning environment where students collaborate with experienced product managers and directly solve real product challenges that apply to their work. 
* **Strategic Leadership and Collaboration**: Fostering the strategic thinking required to guide long-term product development, manage cross-functional teams (including developers, designers, and business leaders), and execute development processes from initial idea to launch.
...
* **[Microdegree No. 1: Digital Product Discovery and Strategy](https://www.ebs.ee/en/continuing-education/microdegrees/digital-product-discovery-and-strategy)**
    * *Focus:* Self-evaluation. Customer development, Jobs-to-be-Done (JTBD), lean canvas validation, and competitor mapping.
* **[Microdegree No. 2: Digital Product Design & Development](https://www.ebs.ee/en/continuing-education/microdegrees/digital-product-design--development)**
    * *Focus:* UX/UI wireframing in Figma, interactive AI prototyping with agentic coding and vibe coding infrastructure.

### 🌸 Spring Semester (Scaling & Execution)
* **[Microdegree No. 3: Digital Product Operations and Process Management](https://www.ebs.ee/en/continuing-education/microdegrees/digital-product-operations-and-process-management)**
    * *Focus:* Agile project methodologies (Scrum/Kanban), quantitative metrics, event-based tracking, and delivery loops.
* **[Microdegree No. 4: Digital Product Leadership, Delivery and Change Management](https://www.ebs.ee/en/continuing-education/microdegrees/digital-product-leadership-delivery-and-change-management)**
    * *Focus:* Product portfolio management, organizational alignment, executive governance, and pitching your final product MVP.
...
This website is a living document. This is the recommended structure:
```
digitalproductmanagement.github.io/
├── README.md                 # Front page
├── GETTING_STARTED.md        # Day 0 Installation & Onboarding Guide
│
├── modules/                  # Documentation for the 4 Micro-degrees
│   ├── module-1-discovery/   # Requirements, readings, lean canvas guides
│   ├── module-2-design/      # Lovable.ai setup, Figma asset guides
│   ├── module-3-operations/  # Metrics definitions, sprint tracking guides
│   └── module-4-scaled/      # Capstone portfolio expectations
│
├── slides/                   # Lecture presentations & course materials
│   ├── module-1-day1.pdf     # Traditional PDF slides
│   └── templates/            # Markdown-based slide templates (Marp/Slidev)
│
├── assets/                   # Static images, logos, and stylesheets
│   └── logos/                # Branding assets
│
└── samples/                  # LIVE HTML/CSS/JS web pages deployed to the web
    ├── portfolio-template/   # Base template for students' personal pages
    │   └── index.html
    └── mvp-landing-page/     # A sample validation landing page for Module II
        ├── index.html
        ├── style.css
        └── app.js
```
